...
const App: React.FC = () => {
  ...
  useEffect(() => {
    localStorage.setItem(
      LOCAL_STORAGE_KEY,
      JSON.stringify({ ingredients, baseServings, currentServings, instructions })
    );
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6">
            <h2 className="text-xl font-semibold mb-4 text-[#444] dark:text-gray-200">🍛 Servings Control</h2>
            <ServingsControl
          ...
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6">
            <h2 className="text-xl font-semibold mb-4 text-[#444] dark:text-gray-200">➕ Add Ingredient</h2>
            <IngredientForm onAdd={handleAddIngredient} />
          </div>
        </div>

        <div className="mt-8 bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6">
          <h2 className="text-xl font-semibold mb-4 text-[#444] dark:text-gray-200">🧾 Ingredient List</h2>
          <IngredientList
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6">
          <h2 className="text-xl font-semibold mb-4 text-[#444] dark:text-gray-200">💾 Save & Load</h2>
          <SaveLoadControls
            ingredients={ingredients}
            baseServings={baseServings}
            currentServings={currentServings}
